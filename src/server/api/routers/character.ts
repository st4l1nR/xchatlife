...
const createCharacterSchema = z.object({
  ...
  hairColor: z.enum(["brunette", "blonde", "black", "redhead", "pink", "blue", "purple", "white", "multicolor"]),
  ...
  personality: z.enum(["nympho", "lover", "submissive", "dominant", "temptress", "innocent", "caregiver", "experimenter", "mean", "confidant", "shy", "queen"]),
  relationship: z.enum(["stranger", "girlfriend", "sex_friend", "school_mate", "work_colleague", "wife", "mistress", "friend", "step_sister", "step_mom"]),
  occupation: z.enum(["student", "dancer", "model", "stripper", "maid", "cam_girl", "boss", "babysitter", "pornstar", "streamer", "bartender", "tech_engineer", "lifeguard", "cashier", "massage_therapist", "teacher", "nurse", "secretary", "yoga_instructor", "fitness_coach"]),
  kinks: z.array(z.enum(["daddy_dominance", "bondage", "spanking", "collar_leash", "punishment", "humiliation", "public_play", "roleplay", "anal_play", "oral_play", "cum_play", "creampie", "squirting", "dirty_talk", "breeding", "edging", "obedience", "control", "inexperienced", "shy_flirting", "playful_teasing", "cuddling", "slow_sensual", "hair_pulling"])).min(1).max(3),
  voice: z.string(),
  // Media URLs (R2 URLs)
