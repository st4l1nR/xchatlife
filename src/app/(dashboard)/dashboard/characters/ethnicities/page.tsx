...
import DashboardEthnicitiesPage from "@/app/_components/pages/DashboardEthnicitiesPage";

export default async function EthnicitiesPage() {
  ...
  return <DashboardEthnicitiesPage />;
}
