...
import DashboardHairColorsPage from "@/app/_components/pages/DashboardHairColorsPage";

export default async function HairColorsPage() {
  ...
  return <DashboardHairColorsPage />;
}
