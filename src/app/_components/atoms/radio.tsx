...
const base = [
  ...
  "bg-input group-data-checked:bg-(--radio-checked-bg)",
  // Border
  "border border-border group-data-checked:border-transparent group-data-hover:group-data-checked:border-transparent group-data-hover:border-foreground/30 group-data-checked:bg-(--radio-checked-border)",
  // Inner highlight shadow
  "after:absolute after:inset-0 after:rounded-full after:shadow-[inset_0_1px_--theme(--color-background/15%)]",
  // Indicator color
  "[--radio-indicator:transparent] group-data-checked:[--radio-indicator:var(--radio-checked-indicator)] group-data-hover:group-data-checked:[--radio-indicator:var(--radio-checked-indicator)] group-data-hover:[--radio-indicator:var(--color-foreground)]/10",
  // Focus ring
  ...
  "group-data-disabled:border-border group-data-disabled:bg-muted group-data-disabled:[--radio-checked-indicator:var(--color-muted-foreground)]/50 group-data-disabled:before:bg-transparent",
];

const colors = {
  "dark/zinc":
    "[--radio-checked-bg:var(--color-primary)] [--radio-checked-border:var(--color-primary)] [--radio-checked-indicator:var(--color-primary-foreground)]",
  "dark/white":
    "[--radio-checked-bg:var(--color-primary)] [--radio-checked-border:var(--color-primary)] [--radio-checked-indicator:var(--color-primary-foreground)]",
  white:
    "[--radio-checked-bg:var(--color-background)] [--radio-checked-border:var(--color-border)] [--radio-checked-indicator:var(--color-foreground)]",
  dark: "[--radio-checked-bg:var(--color-primary)] [--radio-checked-border:var(--color-primary)] [--radio-checked-indicator:var(--color-primary-foreground)]",
  zinc: "[--radio-checked-indicator:var(--color-primary-foreground)] [--radio-checked-bg:var(--color-muted)] [--radio-checked-border:var(--color-muted)]",
  red: "[--radio-checked-indicator:var(--color-destructive-foreground)] [--radio-checked-bg:var(--color-destructive)] [--radio-checked-border:var(--color-destructive)]",
  orange:
  ...
  blue: "[--radio-checked-indicator:var(--color-primary-foreground)] [--radio-checked-bg:var(--color-primary)] [--radio-checked-border:var(--color-primary)]",
  indigo:
