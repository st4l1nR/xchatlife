...
export const NavbarItem = forwardRef(function NavbarItem(
  ...
  let classes = clsx(
    ...
    // Hover
    "data-hover:bg-secondary data-hover:*:data-[slot=icon]:fill-foreground",
    // Active
    "data-active:bg-secondary data-active:*:data-[slot=icon]:fill-foreground",
  );
    ...
    <span className={clsx(className, "relative")}>
      {current && (
        <motion.span
          ...
          className="bg-primary absolute inset-x-2 -bottom-2.5 h-0.5 rounded-full"
        />
      )}
      {"href" in props ? (
        <Link
