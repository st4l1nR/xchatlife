...
const base = [
  ...
  "bg-input group-data-checked:bg-(--checkbox-checked-bg)",
  // Border
  ...
  "after:absolute after:inset-0 after:rounded-[calc(0.3125rem-1px)] after:shadow-[inset_0_1px_--theme(--color-background/15%)]",
  // Focus ring
  "group-data-focus:outline-2 group-data-focus:outline-offset-2 group-data-focus:outline-ring",
  // Disabled state
  "group-data-disabled:opacity-50",
  "group-data-disabled:border-border group-data-disabled:bg-muted group-data-disabled:[--checkbox-check:var(--color-muted-foreground)]/50 group-data-disabled:before:bg-transparent",
  // Forced colors mode
...
const colors = {
  ...
  white:
    "[--checkbox-check:var(--color-foreground)] [--checkbox-checked-bg:var(--color-background)] [--checkbox-checked-border:var(--color-border)]/15",
  dark: "[--checkbox-check:var(--color-primary-foreground)] [--checkbox-checked-bg:var(--color-primary)] [--checkbox-checked-border:var(--color-primary)]/90",
  zinc: "[--checkbox-check:var(--color-primary-foreground)] [--checkbox-checked-bg:var(--color-muted)] [--checkbox-checked-border:var(--color-border)]/90",
  red: "[--checkbox-check:var(--color-destructive-foreground)] [--checkbox-checked-bg:var(--color-destructive)] [--checkbox-checked-border:var(--color-destructive)]/90",
  orange:
  ...
  blue: "[--checkbox-check:var(--color-primary-foreground)] [--checkbox-checked-bg:var(--color-primary)] [--checkbox-checked-border:var(--color-primary)]/90",
  indigo:
