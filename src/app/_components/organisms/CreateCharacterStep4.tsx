...
const BODY_TYPE_OPTIONS: Record<
  string,
  ...
  "girl-realistic": [
    {
      value: "skinny",
      label: "Skinny",
      imageSrc: `${GIRLS_REALISTIC_BASE}/body-type/Skinny.png`,
    },
    {
      value: "athletic",
      label: "Athletic",
      imageSrc: `${GIRLS_REALISTIC_BASE}/body-type/Athletic.png`,
    },
    {
      value: "average",
      label: "Average",
      imageSrc: `${GIRLS_REALISTIC_BASE}/body-type/Average.png`,
    },
    {
      value: "curvy",
      label: "Curvy",
      imageSrc: `${GIRLS_REALISTIC_BASE}/body-type/Curvy.png`,
    },
    {
      value: "bbw",
      label: "BBW",
  ...
  "girl-anime": [
    {
      value: "skinny",
      label: "Skinny",
      imageSrc: `${GIRLS_ANIME_BASE}/Body Type/Skinny.webp`,
    },
    {
      value: "athletic",
      label: "Athletic",
      imageSrc: `${GIRLS_ANIME_BASE}/Body Type/Athletic.webp`,
    },
    {
      value: "average",
      label: "Average",
      imageSrc: `${GIRLS_ANIME_BASE}/Body Type/Average.webp`,
    },
    {
      value: "curvy",
      label: "Curvy",
      imageSrc: `${GIRLS_ANIME_BASE}/Body Type/Curvy.webp`,
    },
    // No BBW for anime
  ],
  "trans-realistic": [
    {
      value: "skinny",
      label: "Skinny",
      imageSrc: `${TRANS_REALISTIC_BASE}/Body Type/Skinny.png`,
    },
    {
      value: "athletic",
      label: "Athletic",
      imageSrc: `${TRANS_REALISTIC_BASE}/Body Type/Athletic.png`,
    },
    {
      value: "average",
      label: "Average",
      imageSrc: `${TRANS_REALISTIC_BASE}/Body Type/Average.png`,
    },
    {
      value: "curvy",
      label: "Curvy",
      imageSrc: `${TRANS_REALISTIC_BASE}/Body Type/Curvy.png`,
    },
    {
      value: "bbw",
      label: "BBW",
      imageSrc: `${TRANS_REALISTIC_BASE}/Body Type/BBW.png`,
    },
  ],
};

// Breast Size Options by variant
const BREAST_SIZE_OPTIONS: Record<
  string,
  ...
  "girl-realistic": [
    {
      value: "small",
      label: "Small",
      imageSrc: `${GIRLS_REALISTIC_BASE}/breast-size/Small.png`,
    },
    {
      value: "medium",
      label: "Medium",
      imageSrc: `${GIRLS_REALISTIC_BASE}/breast-size/Medium.png`,
    },
    {
      value: "large",
      label: "Large",
      imageSrc: `${GIRLS_REALISTIC_BASE}/breast-size/Large.png`,
    },
    {
      value: "extra_large",
      label: "Extra Large",
  ...
  "girl-anime": [
    {
      value: "small",
      label: "Small",
      imageSrc: `${GIRLS_ANIME_BASE}/Breast Size/Small.webp`,
    },
    {
      value: "medium",
      label: "Medium",
      imageSrc: `${GIRLS_ANIME_BASE}/Breast Size/Medium.webp`,
    },
    {
      value: "large",
      label: "Large",
      imageSrc: `${GIRLS_ANIME_BASE}/Breast Size/Large.webp`,
    },
    {
      value: "extra_large",
      label: "Extra Large",
