...
const bodyTypeOptions = [
  { value: "skinny" as const, label: "Skinny", imageSrc: `${STEP4_BASE}/body-type/Skinny.png` },
  { value: "athletic" as const, label: "Athletic", imageSrc: `${STEP4_BASE}/body-type/Athletic.png` },
  { value: "average" as const, label: "Average", imageSrc: `${STEP4_BASE}/body-type/Average.png` },
  { value: "curvy" as const, label: "Curvy", imageSrc: `${STEP4_BASE}/body-type/Curvy.png` },
  { value: "bbw" as const, label: "BBW", imageSrc: `${STEP4_BASE}/body-type/BBW.png` },
];

const breastSizeOptions = [
  { value: "small" as const, label: "Small", imageSrc: `${STEP4_BASE}/breast-size/Small.png` },
  { value: "medium" as const, label: "Medium", imageSrc: `${STEP4_BASE}/breast-size/Medium.png` },
  { value: "large" as const, label: "Large", imageSrc: `${STEP4_BASE}/breast-size/Large.png` },
  { value: "extra-large" as const, label: "Extra Large", imageSrc: `${STEP4_BASE}/breast-size/Extra Large.png` },
];
