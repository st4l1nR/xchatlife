...
export const kinksSchema = z.array(z.string()).min(1, "Select at least 1 kink").max(3, "Maximum 3 kinks");
...
export const OCCUPATION_OPTIONS = [
  ...
  { value: "babysitter" as const, label: "Babysitter / Au Pair", emoji: "\uD83C\uDF7C" },
  ...
  { value: "massage-therapist" as const, label: "Massage Therapist", emoji: "\uD83D\uDC86" },
