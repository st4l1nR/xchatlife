...
import DashboardPersonalitiesPage, {
  defaultMockData,
} from "@/app/_components/pages/DashboardPersonalitiesPage";
import type { PropertyItem } from "@/app/_components/organisms/ListCardProperty";

const meta = {
  title: "Pages/DashboardPersonalitiesPage",
  component: DashboardPersonalitiesPage,
  parameters: {
    layout: "fullscreen",
    nextjs: {
      appDirectory: true,
      navigation: { pathname: "/dashboard/personalities" },
    },
  },
  decorators: [
    (Story) => (
  ...
  tags: ["autodocs"],
} satisfies Meta<typeof DashboardPersonalitiesPage>;
