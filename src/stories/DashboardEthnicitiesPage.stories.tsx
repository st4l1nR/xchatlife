...
import DashboardEthnicitiesPage, {
  defaultMockData,
} from "@/app/_components/pages/DashboardEthnicitiesPage";
import type { PropertyItem } from "@/app/_components/organisms/ListCardProperty";

const meta = {
  title: "Pages/DashboardEthnicitiesPage",
  component: DashboardEthnicitiesPage,
  parameters: {
    layout: "fullscreen",
    nextjs: {
      appDirectory: true,
      navigation: { pathname: "/dashboard/ethnicities" },
    },
  },
  decorators: [
    (Story) => (
  ...
  tags: ["autodocs"],
} satisfies Meta<typeof DashboardEthnicitiesPage>;
...
const InteractiveWrapper = () => {
  ...
  return <DashboardEthnicitiesPage mock={{ items }} />;
};
