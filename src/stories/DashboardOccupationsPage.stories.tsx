...
import DashboardOccupationsPage, {
  defaultMockData,
} from "@/app/_components/pages/DashboardOccupationsPage";
import type { PropertyItem } from "@/app/_components/organisms/ListCardProperty";

const meta = {
  title: "Pages/DashboardOccupationsPage",
  component: DashboardOccupationsPage,
  parameters: {
    layout: "fullscreen",
    nextjs: {
      appDirectory: true,
      navigation: { pathname: "/dashboard/occupations" },
    },
  },
  decorators: [
    (Story) => (
  ...
  tags: ["autodocs"],
} satisfies Meta<typeof DashboardOccupationsPage>;
...
const InteractiveWrapper = () => {
  ...
  return <DashboardOccupationsPage mock={{ items }} />;
};
