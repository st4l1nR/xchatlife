...
import DashboardStylesPage, {
  defaultMockData,
} from "@/app/_components/pages/DashboardStylesPage";
import type { PropertyItem } from "@/app/_components/organisms/ListCardProperty";

const meta = {
  title: "Pages/DashboardStylesPage",
  component: DashboardStylesPage,
  parameters: {
    layout: "fullscreen",
    nextjs: {
      appDirectory: true,
      navigation: { pathname: "/dashboard/styles" },
    },
  },
  decorators: [
    (Story) => (
  ...
  tags: ["autodocs"],
} satisfies Meta<typeof DashboardStylesPage>;
...
const InteractiveWrapper = () => {
  ...
  return <DashboardStylesPage mock={{ items }} />;
};
