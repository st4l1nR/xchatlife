...
import DashboardGendersPage, {
  defaultMockData,
} from "@/app/_components/pages/DashboardGendersPage";
import type { PropertyItem } from "@/app/_components/organisms/ListCardProperty";

const meta = {
  title: "Pages/DashboardGendersPage",
  component: DashboardGendersPage,
  parameters: {
    layout: "fullscreen",
    nextjs: {
      appDirectory: true,
      navigation: { pathname: "/dashboard/genders" },
    },
  },
  decorators: [
    (Story) => (
  ...
  tags: ["autodocs"],
} satisfies Meta<typeof DashboardGendersPage>;
...
const InteractiveWrapper = () => {
  ...
  return <DashboardGendersPage mock={{ items }} />;
};
